...
type CatchRequestsHelper = import('../helpers/catch_request_helper');
...
declare namespace CodeceptJS {
  ...
  interface Methods extends Playwright, CustomCommands, PlaywrightBrowser, CatchRequestsHelper, ChaiWrapper {}
